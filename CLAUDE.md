...
- `registry.json` (repo root) — generated, not hand-edited. A path-only copy of `registry/react/registry.json` for the GitHub `owner/repo/item` addressing shorthand.
