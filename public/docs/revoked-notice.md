...
Sharing has been withdrawn, and the message should say that plainly rather than suggest that waiting will help.

## Not for

A lifetime that simply ran out. Use Expired notice.
...
[Live demo](https://knock.codes/playground/revoked-notice) · [Registry JSON](https://knock.codes/r/revoked-notice.json) · [Source](https://knock.codes/source/revoked-notice.tsx)
...
| heading | `ReactNode` | no | 'This preview is no longer shared.' | Overrides the default heading. |
| description | `ReactNode` | no | 'The owner has withdrawn access. Contact them if you need another look.' | Overrides the default description. |
...
- Rendering this revokes nothing. Your application stops serving the preview; this block reports the decision.
- `unlocked` still governs what the block shows.
...
- heading: ReactNode; default 'This preview is no longer shared.'
- description: ReactNode; default 'The owner has withdrawn access. Contact them if you need another look.'
...
Use it when: Sharing has been withdrawn, and the message should say that plainly rather than suggest that waiting will help.
Do not use it for: A lifetime that simply ran out. Use Expired notice.
Common mistakes:
- Rendering this revokes nothing. Your application stops serving the preview; this block reports the decision.
- `unlocked` still governs what the block shows.
...
export default function Example() {
  ...
  return <section aria-label="Revoked notice example">
    {/* Demo consumer state only. Integrate your authorization outside this UI. */}
    <RevokedNotice value={value} onChange={setValue} onSubmit={event => { event.preventDefault(); setMessage("Demo submitted"); }} status="idle" unlocked={unlocked}><p>Preview content</p></RevokedNotice>
