...
Install and wire Preview chrome (PreviewChrome) from https://knock.codes/r/preview-chrome.json in a React + Tailwind project. Read https://knock.codes/docs/preview-chrome.md before editing.
