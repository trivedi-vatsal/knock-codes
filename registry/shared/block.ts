/** MIT License — Copyright (c) 2026 Knock contributors. Authoring-only; generate.ts inlines this into each published block. */
import { type FormEvent, type ReactNode } from 'react';

export interface KnockBlockProps {
